...
\begin{table}[H]
	\caption[RACI matrix for the verification lifecycle]{RACI matrix for the verification lifecycle (Adapted from \cite{cybersierra_security_raci_2026})}
