...
%TODO abbildungen verbessern: NV1: IP-based tests (e.g. HTTP) und Unexpected comm. partner ist im pfeil drin; NV2: roter pfeil nicht ersichtlich, dass es zu mirrorred traffic (L2) gehört; NV3: Text direct link disconnected in den kästen von den anderen drin
%TODO caption anpassen, damit man anhang von der caption versteht was die abbildung sagen soll;
...
\label{subsec:nv1} 
%The test system communicates as a regular participant with the SUT and the controller over the switch, simulating an insider scenario (vgl. NIST SP 800-115, Sec. 5.2.2). NV1 supports all IP-based tests, including the IoT-Core HTTP services (vgl. NIST SP 800-115, Sec. 4.2), and any test in which the test system acts as an unexpected communication partner interacting directly with the network (vgl. NIST SP 800-115, Sec. 2.3).
