...
%TODO Quellen
The feasibility of a test depends on the position of the test system on the communication path. The methodology defines three network access variants, each providing a different level of access: direct access (Section \ref{subsec:nv1}), passive observation (Section \ref{subsec:nv2}), and active in-path manipulation (Section \ref{subsec:}). Figures \ref{fig:nv1}, \ref{fig:nv2}, and \ref{fig:nv3} illustrate the three variants. 
