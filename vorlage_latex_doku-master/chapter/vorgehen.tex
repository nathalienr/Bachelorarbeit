...
All acceptance criteria and all requirement verdicts reported in Chapter \ref{chap:implementation_results} are evaluated at this declared level. If the target level changes, the affected Component Requirements, test depth and verdicts must be reassessed.
