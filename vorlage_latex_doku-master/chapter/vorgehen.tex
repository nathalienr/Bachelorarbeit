...
\begin{itemize} 
	...
	\item \textbf{Not Applicable:} the assumed interface, function, or topology is absent. This is a technical applicability finding, not a product failure. \item \textbf{Blocked:} the test could not be run because of an environmental or tool constraint \cite[p. 11]{glossar2013istqb}. 
\end{itemize} 
