...
\begin{table}[H] 
	...
	\begin{tabularx}{\textwidth}{l l X X l} 
		...
		\addlinespace
		RQ-004 & D & Integrity protection / identification & \gls{acr:IoT}-Core \texttt{deviceinfo}/\texttt{firmware} & NV1 \\ 
		\addlinespace 
		RQ-005 & D & Integrity protection & Firmware update service & NV1, NV3 \\ 
		\addlinespace 
		RQ-006 & D & Identification & \gls{acr:IoT}-Core \texttt{firmware} & NV1 \\ 
		\addlinespace 
		RQ-007 & D, H & Availability & IoT-Core \texttt{deviceinfo}, \gls{acr:HTTP} service & NV1 \\ 
...
\begin{table}[H] 
	...
	\begin{tabularx}{\textwidth}{l l X} \toprule \textbf{CM} & \textbf{Tool} & \textbf{Applicability outcome} \\ 
		...
		CM-005 & SSLscan & Not applicable to the original procedure; \gls{acr:TCP}/80 provided \gls{acr:HTTP} without a \gls{acr:TLS} handshake or certificate \\ 
...
%TODO sind alle Ergebnisse wie ich sie dokumentiert habe korrekt?
