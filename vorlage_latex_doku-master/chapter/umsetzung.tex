...
The System Under Test is the Safe Remote \gls{acr:I/O} (\gls{acr:SRIO}), a fieldbus-based safety component that exchanges safety-related input and output data with a higher-level safety controller over \gls{acr:PROFINET} and PROFIsafe. The evaluated unit identified itself over the IoT-Core interface as product \texttt{ifm-AL400S}, hardware version 1.4.0.2, hardware revision AA, and software revision 1.1.4.888. All reported results refer exclusively to this configuration.
